...
try
{
	...
	//String q3="create table cart(email varchar(100),product_id int,quantity int,price int,total int,address varchar(500),city varchar(100),state varchar(100),country varchar(100),mobileNumber bigint,orderDate varchar(100),deliveryDate varchar(100),paymentMethod varchar(100),trasactionId varchar(100),status varchar(100))";
	//String q4="create table message (id int AUTO_INCREMENT,email varchar(100),subjet varchar(200),body varchar(1000),PRIMARY KEY(id))";
